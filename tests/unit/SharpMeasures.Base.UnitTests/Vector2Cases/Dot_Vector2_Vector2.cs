...
public sealed class Dot_Vector2_Vector2
{
    ...
    [Theory]
    [ClassData(typeof(Dataset))]
    public void A_Positive_EqualsInstanceMethod(Vector2 a) => EqualsInstanceMethod(a, Scalar.NegativeInfinity * Vector2.Ones);

    [Theory]
    [ClassData(typeof(Dataset))]
    public void B_Positive_EqualsInstanceMethod(Vector2 b) => EqualsInstanceMethod(Scalar.NegativeInfinity * Vector2.Ones, b);
