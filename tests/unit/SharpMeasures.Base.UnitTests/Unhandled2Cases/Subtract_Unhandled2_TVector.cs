...
public sealed class Subtract_Unhandled2_TVector
{
    private static Unhandled2 Target<TVector>(Unhandled2 a, TVector b) where TVector : IVector2Quantity => Unhandled2.Subtract(a, b);
