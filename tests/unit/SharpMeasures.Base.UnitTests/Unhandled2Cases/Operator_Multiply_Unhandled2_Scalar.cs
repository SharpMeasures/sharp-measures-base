...
public sealed class Operator_Multiply_Unhandled2_Scalar
{
    ...
    [Theory]
    [ClassData(typeof(Dataset))]
    public void Positive_EqualsMethod(Unhandled2 a) => EqualsMethod(a, 1.5);

    [Theory]
    [ClassData(typeof(Dataset))]
    public void Negative_EqualsMethod(Unhandled2 a) => EqualsMethod(a, -1.5);
