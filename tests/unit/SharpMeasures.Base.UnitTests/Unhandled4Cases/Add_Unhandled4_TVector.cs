...
public sealed class Add_Unhandled4_TVector
{
    private static Unhandled4 Target<TVector>(Unhandled4 a, TVector b) where TVector : IVector4Quantity => Unhandled4.Add(a, b);
