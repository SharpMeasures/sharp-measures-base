...
public sealed class Difference_Unhandled_TScalar
{
    private static Unhandled Target<TScalar>(Unhandled x, TScalar y) where TScalar : IScalarQuantity<TScalar> => Unhandled.Difference(x, y);
