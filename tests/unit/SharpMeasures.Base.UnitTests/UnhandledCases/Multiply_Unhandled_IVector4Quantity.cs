...
public sealed class Multiply_Unhandled_IVector4Quantity
{
    private static Unhandled4 Target(Unhandled a, IVector4Quantity b) => Unhandled.Multiply(a, b);
    ...
    [AssertionMethod]
    private static void EqualsInstanceMethod(Unhandled a, IVector4Quantity b)
    {
