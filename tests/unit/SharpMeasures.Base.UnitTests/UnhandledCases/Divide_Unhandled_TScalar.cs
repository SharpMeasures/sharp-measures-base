...
public sealed class Divide_Unhandled_TScalar
{
    private static Unhandled Target<TScalar>(Unhandled x, TScalar y) where TScalar : IScalarQuantity<TScalar> => Unhandled.Divide(x, y);
