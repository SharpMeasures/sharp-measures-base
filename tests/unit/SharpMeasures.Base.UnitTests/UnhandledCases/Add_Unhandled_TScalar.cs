...
public sealed class Add_Unhandled_TScalar
{
    private static Unhandled Target<TScalar>(Unhandled x, TScalar y) where TScalar : IScalarQuantity<TScalar> => Unhandled.Add(x, y);
