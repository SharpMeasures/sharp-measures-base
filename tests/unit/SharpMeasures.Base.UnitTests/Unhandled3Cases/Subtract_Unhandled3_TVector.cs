...
public sealed class Subtract_Unhandled3_TVector
{
    private static Unhandled3 Target<TVector>(Unhandled3 a, TVector b) where TVector : IVector3Quantity => Unhandled3.Subtract(a, b);
